...
class StrategyConfig(BaseModel):
    """✅ FIXED: Enhanced strategy configuration with leverage awareness and validation."""
...
class GlobalConfig(BaseModel):
    """✅ FIXED: Enhanced global configuration with leverage support."""
...
def create_config(env: Optional[Environment] = None, **overrides) -> GlobalConfig:
    """✅ FIXED: Create configuration with environment-specific settings and leverage support."""
    try:
...
def validate_configuration(config: GlobalConfig) -> List[str]:
    """✅ FIXED: Validate configuration with leverage awareness."""
    warnings_list = []
...
if __name__ == "__main__":
    ...
    try:
        ...
        # ✅ FIXED: Display leverage-related calculations
        ...
        print(f"Reward Scaling Factor: {reward_scaling_factor:.2f}")
