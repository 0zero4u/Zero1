...
class FixedRewardCalculator:
    ...
    # --- END OF FIX ---
        ...
        try:
            ...
            # This logic now directly uses the flag from the environment, closing the loophole.
            ...
            # --- START OF CRITICAL FIX: Isolate Normalization from Intrinsic Rewards ---
            # 1. Update the normalizer ONLY with the raw (extrinsic) reward.
            ...
            # 3. Add the intrinsic (behavior-shaping) reward AFTER normalization.
            # This makes penalties like frequency_penalty a fixed cost the agent cannot game.
