...
class RewardManager:
    ...
    def _calculate_raw_components(self, **kwargs) -> Dict[str, float]:
        ...
        # --- START OF IMPROVED ACTION CLARITY LOGIC ---
        # This "Hybrid Slope" rewards any executable action (>= 0.01) but
        # rewards larger, more decisive actions exponentially more.
        if action_size >= 0.01:
            # Using action_size squared creates an accelerating reward curve.
            # The multiplier (0.5) scales the max reward to a reasonable level.
            components['action_clarity'] = (action_size ** 2) * 0.5
        else:
            components['action_clarity'] = 0.0
        # --- END OF IMPROVED ACTION CLARITY LOGIC ---
