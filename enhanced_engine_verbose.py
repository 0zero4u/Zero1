...
class FixedRewardCalculator:
    ...
    # --- END OF FIX ---
        ...
        try:
            ...
            # Penalize any trade whose notional value is positive but too small (less than 0.1% of portfolio value).
            # This directly targets thrashing with insignificant trade sizes.
