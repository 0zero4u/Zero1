...
class RewardManager:
    ...
    def __init__(self, weights: Dict[str, float]):
        ...
        # --- FIX 1: Removed 'tiny_action' and 'hesitation' from penalties ---
        self.penalty_components = {'trade_cost', 'drawdown', 'frequency', 'inactivity', 'thrashing'}
        # --- FIX 2: Removed REWARD_SCALE_FACTOR. Normalizer now handles all scaling. ---
    ...
    def _calculate_raw_components(self, **kwargs) -> Dict[str, float]:
        ...
        # --- FIX 1: REMOVED the entire 'tiny_action' and 'hesitation' penalty block. ---
        # This was the primary cause of the agent learning to do nothing ("turtling").
        # Transaction costs now serve as the natural penalty for pointless micro-trades.
    ...
    def _transform_to_ratios(self, raw_components: Dict[str, float], **kwargs) -> Dict[str, float]:
        ...
        # --- FIX 2: Removed REWARD_SCALE_FACTOR. Normalizer handles scaling correctly. ---
        ...
        # --- FIX 3: Strengthened the inactivity penalty ---
        inactivity_penalty = 0.0
        # Activate penalty sooner (after 5 steps) and make it stronger (/ 50.0)
...
class EnhancedRiskManager:
    ...
    def get_volatility_percentile(self, current_volatility: float) -> float:
        ...
        # --- CORRECTED: Removed stray 'sel' syntax error ---
...
class FixedHierarchicalTradingEnvironment(gymnasium.Env):
    ...
    def __init__(self, df_base_ohlc: pd.DataFrame, normalizer: Normalizer, config=None,
        ...
        try:
            ...
            # --- FIX 1: Removed 'tiny_action' and 'hesitation' from default weights ---
            ...
            # --- START OF FIX: Corrected typo "fselfor" to "for" ---
    ...
    def step(self, action: np.ndarray):
        try:
            ...
            # --- CORRECTED: Indentation for flip calculation logic ---
            ...
            if self.verbose:
                if is_executed_trade:
                    ...
                    # This now only runs if is_executed_trade is FALSE
