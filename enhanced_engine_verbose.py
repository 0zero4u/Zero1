...
class FixedRewardCalculator:
    ...
    def _get_market_multipliers(self, market_regime: str) -> Dict[str, float]:
        ...
        base_multipliers = {
            "HIGH_VOLATILITY": {"exploration_bonus": 1.5},
            "TRENDING_UP": {"base_return": 1.2, "drawdown_penalty": 0.8},
            "TRENDING_DOWN": {"base_return": 1.2, "drawdown_penalty": 0.8},
            "LOW_VOLATILITY": {"exploration_bonus": 0.8},
            "SIDEWAYS": {"transaction_penalty": 1.5},
