...
class RewardManager:
    ...
    def _transform_to_ratios(self, raw_components: Dict[str, float], **kwargs) -> Dict[str, float]:
        ...
        # --- START OF FIX: Remove incorrect scaling from penalties that are already ratios ---
        # These values (e.g., drawdown, thrashing_ratio) are already in a sensible 0.0-1.0 range.
        # Multiplying them by REWARD_SCALE_FACTOR was the source of the "penalty death spiral".
