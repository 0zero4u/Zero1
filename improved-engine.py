...
class HierarchicalTradingEnvironment(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        self.previous_action = None # FIX: Initialize previous_action
    ...
    def step(self, action: np.ndarray):
        ...
        # FIX: Pass the current action to the reward function
        reward = self._calculate_enhanced_reward(initial_portfolio_value, next_portfolio_value, action)
        
        # FIX: Store the action for the next step's reward calculation
