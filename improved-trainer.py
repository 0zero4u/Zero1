...
class OptimizedTrainer:
    """IMPROVED: Enhanced trainer with pre-loaded data and better objective metrics."""
    ...
    def create_environment(self, config: Dict[str, Any]) -> HierarchicalTradingEnvironment:
        ...
        # IMPROVEMENT: Use pre-loaded data instead of reloading
        env = HierarchicalTradingEnvironment(self.bars_df)
    ...
    def create_model(self, env: HierarchicalTradingEnvironment, trial: optuna.Trial) -> PPO:
    ...
    def objective(self, trial: optuna.Trial) -> float:
        """IMPROVED: Optuna objective function with better metrics."""
        try:
            # Create environment and model using pre-loaded data
            ...
            # IMPROVED: Calculate final performance metric using Calmar Ratio
