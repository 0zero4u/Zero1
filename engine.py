# REFINED: engine.py with Path-Aware Decayed Reward System (CORRECTED)
...
class AdvancedRewardCalculator:
    ...
    def __init__(self, config, leverage: float = 10.0, reward_weights: Dict[str, float] = None):
        ...
        self.weights = reward_weights or {
            ...
            'risk_adjusted': 0.3,
            'stability': 0.2,
            # CORRECTED: All penalty weights should be negative to signify a penalty.
    ...
    def calculate_enhanced_reward(self, prev_value: float, curr_value: float,
        ...
        try:
            ...
            if previous_action is not None:
                ...
                # CORRECTED: Removed the extra negative sign. The weight is already negative.
                # This fixes the bug where trading was being rewarded instead of penalized.
            ...
            if current_drawdown > 0.05:
                ...
                # CORRECTED: Removed the extra negative sign for consistency. The weight is negative.
            ...
            if position_size > 0.8:
                ...
                # CORRECTED: Removed the extra negative sign. The weight is already negative.
                # This fixes the bug where large positions were being rewarded.
...
class EnhancedHierarchicalTradingEnvironment(gym.Env):
    ...
    def step(self, action: np.ndarray):
        ...
        try:
            ...
            # Calculate drawdown from the episode's peak value for termination
