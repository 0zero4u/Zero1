            ...
            try:
                ...
                if trial_params:
                    ...
                    reward_weights = {
                        ...
                        'risk_bonus': trial_params.get('reward_weight_risk_bonus', 0.05),
                        ...
                        'action_reward': trial_params.get('reward_weight_action_reward', 0.06),
                        # NEW: Pass the hyperactivity penalty weight
    ...
    def objective(self, trial) -> float:
        ...
        try:
            trial_params = {
                ...
                'reward_weight_risk_bonus': trial.suggest_float('reward_weight_risk_bonus', 0.05, 0.3),
                ...
                'reward_weight_action_reward': trial.suggest_float('reward_weight_action_reward', 0.05, 0.4),
...
def train_model_fixed(optimization_trials: int = 20,
    ...
    """
    try:
        logger.info("🎯 Starting FIXED Training (Post-Analysis System)")
