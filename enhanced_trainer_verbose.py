    ...
    def objective(self, trial) -> float:
        ...
        try:
            trial_params = {
                ...
                'reward_weight_exploration_bonus': trial.suggest_float('reward_weight_exploration_bonus', 0.03, 0.15),
                # --- END OF FIX ---
            ...
            hparam_metrics_to_log = ['eval/mean_reward', 'performance/total_return_raw'] # NEW: Log raw return
            ...
            if perf_callback.portfolio_values and perf_callback.raw_rewards:
                ...
                self.logger.record('performance/total_return_raw', total_return_raw)
