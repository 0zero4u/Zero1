    ...
    def objective(self, trial) -> float:
        ...
        try:
            ...
            trial_params = {
                ...
                'reward_weight_tiny_action': trial.suggest_float('reward_weight_tiny_action', 0.8, 2.0),
                'reward_weight_action_clarity': trial.suggest_float('reward_weight_action_clarity', 0.05, 0.4),
                # This ensures the hesitation penalty is active and fixed during all optimization trials.
