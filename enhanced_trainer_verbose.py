...
class EnhancedFixedTrainer:
    ...
    def objective(self, trial) -> float:
        ...
        try:
            trial_params = {
                # PPO Core: More conservative and stable learning
                ...
                # Transformer Architecture: Favor stability
                ...
                # Strategy & Risk: Reduce risk and encourage patience
                ...
                'reward_scaling_factor': trial.suggest_float('reward_scaling_factor', 75.0, 250.0),
    ...
    def optimize(self, n_trials: int = 50, timeout: Optional[int] = None):
        ...
        try:
            # --- START OF FIX: Enable persistent, resumable Optuna studies ---
            db_path = SETTINGS.get_optuna_db_path()
            storage_name = f"sqlite:///{db_path}" # Defines the database file path
            ...
            # THIS LINE CREATES/CONNECTS TO A DATABASE FILE ON DISK.
            # PROGRESS IS SAVED AFTER EACH TRIAL.
