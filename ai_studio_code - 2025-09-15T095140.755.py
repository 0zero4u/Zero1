# --- START OF FILE enhanced_engine_verbose (7).py ---
...
class FixedHierarchicalTradingEnvironment(gymnasium.Env):
    ...
    def step(self, action: np.ndarray):
        try:
            ...
            # Update portfolio history for performance metrics calculation
    ...
    def reset(self, seed=None, options=None):
        try:
            ...
            # --- *** FINAL FIX APPLIED HERE *** ---
            # Initialize portfolio history for performance metrics
