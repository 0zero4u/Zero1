...
class AdvancedRewardCalculator:
    ...
    def __init__(self, config, leverage: float = 10.0, reward_weights: Dict[str, float] = None):
        ...
        self.weights = reward_weights or {
            ...
            'drawdown_penalty': 0.4, # FIX: Changed from -0.4 to 0.4 to make it a penalty
    ...
    def calculate_enhanced_reward(self, prev_value: float, curr_value: float,
        ...
        try:
            ...
            if current_drawdown > 0.05:
                ...
                components['drawdown_penalty'] = -penalty_factor * self.weights['drawdown_penalty'] # Corrected: now multiplies by positive weight
            else:
...
class EnhancedHierarchicalTradingEnvironment(gym.Env):
    ...
    def step(self, action: np.ndarray):
        ...
        try:
            ...
            terminated = next_portfolio_value <= initial_portfolio_value * (1.0 - self.strat_cfg.max_drawdown_threshold)
