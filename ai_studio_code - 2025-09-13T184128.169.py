...
class EnhancedFixedTrainer:
    ...
    def objective(self, trial) -> float:
        ...
        try:
            # --- START OF FIX #3: Tighter Hyperparameter Ranges ---
            trial_params = {
                # PPO Core
                ...
                # Tighter, more focused reward weight ranges
            ...
            # --- START OF FIX #3: Prune invalid PPO configurations ---
